(function (root, factory) {
  ...
  const PROVIDERS = [
    ...
    },
    {
      ...
      auth: { type: 'x-api-key' }, docsUrl: 'https://platform.claude.com/docs/en/api/overview',
    ...
    },
    {
      ...
      auth: { type: 'bearer' }, docsUrl: 'https://docs.perplexity.ai/docs/agent-api/quickstart',
      endpoints: [
    ...
    },
    {
      ...
      auth: { type: 'bearer' }, docsUrl: 'https://docs.fireworks.ai/getting-started/quickstart',
      endpoints: [
    ...
    },
    {
      ...
      auth: { type: 'bearer' }, docsUrl: 'https://inference-docs.cerebras.ai/api-reference/authentication',
      endpoints: [
        ep('models', 'List Models', 'GET', '/v1/models', 'models'),
        ep('chat', 'Chat Completions', 'POST', '/v1/chat/completions', 'openai_chat')
      ]
    },
    {
      ...
      auth: { type: 'bearer' }, docsUrl: 'https://docs.api.nvidia.com/nim/re/reference/llm-apis',
      endpoints: [
  ...
  return { VERIFIED_AT, PROVIDERS, getProvider, getEndpoint, getModelsEndpoint, resolveEndpointPath, validateModelForPath };
});
